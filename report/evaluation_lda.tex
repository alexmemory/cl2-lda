...
MaxEnt & \textbf{0.20} (.05) &  \textbf{.68} (.04) \\
Naive & \textbf{0.70} (.06) &  \textbf{.68} (.05) \\
\end{tabular}
\caption{\textbf{Task 1}: Accuracy and StdDev}
\end{centering}
\end{table}
...
MaxEnt & \textbf{0.23} (0.04) &  \textbf{0.21} (0.05) \\
Naive & \textbf{0.74} (0.05) &  \textbf{0.71} (0.09) \\
\end{tabular}
\caption{\textbf{Task 2}: Accuracy and StdDev}
\end{centering}
\end{table}
...
MaxEnt & \textbf{0.22} (0.05) &  \textbf{0.26} (0.04) \\
Naive & \textbf{0.70} (0.10) &  \textbf{0.71} (0.07) \\
\end{tabular}
\caption{\textbf{Task 3}: Accuracy and StdDev}
\label{tab:task3boydstunlda}
\end{centering}
\end{table}
